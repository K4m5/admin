      ...
      <div className="row">
        <div className="col-lg-4 col-6">
          ...
          <div className="small-box bg-info">
            <div className="inner">
              <h3>{currentRevenue.dailyRevenue.toLocaleString() || 0}đ</h3>
        ...
        <div className="col-lg-4 col-6">
          ...
          <div className="small-box bg-success">
            <div className="inner">
              <h3>{currentRevenue.weeklyRevenue.toLocaleString() || 0}đ</h3>
        ...
        <div className="col-lg-4 col-6">
          ...
          <div className="small-box bg-warning">
            <div className="inner">
              <h3>{currentRevenue.monthlyRevenue.toLocaleString() || 0}đ</h3>
